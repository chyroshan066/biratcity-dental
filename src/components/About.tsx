        ...
        <div className="custom-container">
            ...
            <div>
                ...
                <p className="section-text section-text-1">
                    Welcome to <b>Basuki Dental Clinic</b>, your trusted <b>dental clinic in Biratnagar</b> located at Mahendra Chowk, Biratnagar-11, Morang, Nepal. With the motto <i>“Professional Dentist, Advanced Technology and Affordable Price”</i>, we are committed to providing high-quality <b>dental care in Nepal</b> for every smile.
                </p>
                ...
                <p className="section-text section-text-1">
                    At <b>Basuki Dental Nepal</b>, we combine modern technology with compassionate care to make treatments comfortable and accessible. Whether you need a routine <b>dental checkup in Biratnagar, emergency dental care,</b> or advanced solutions for restoring your smile, our clinic ensures the best outcomes at an <b>affordable price.</b>
                </p>
                <p className="section-text">
                    Choose <b>Basuki Dental</b> for the <b>best dentist in Biratnagar,</b> where healthy smiles begin with expert care and a personal touch.
                </p>
