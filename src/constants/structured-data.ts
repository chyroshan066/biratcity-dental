...
export const dentalClinicStructuredData: DentalBusinessStructuredData = {
  "@context": "https://schema.org",
  "@type": "Dentist",
  "name": "BiratCity Dental", 
  "description": "Professional dental care services in Biratnagar. Comprehensive oral health treatments including routine checkups, advanced procedures, orthodontics, and emergency dental care. Modern equipment, experienced dentists, and patient-focused approach.", 
  "url": process.env.NEXT_PUBLIC_BASE_URL,
  
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "ShaniMandir",
  ...
  "telephone": "+977-9704505959",
  "email": "biratcitydentalclinic@gmail.com",
  ...
  "sameAs": [
    "https://www.facebook.com/profile.php?id=61555746518031",
    "https://www.tiktok.com/@biratcity.dental?_t=ZS-8zigWUEiXFi&_r=1"
  ],
